...
#保持实现了INoProguard不混淆
-keep public class * implements com.liang530.event.INoProguard
-keepnames class * implements com.liang530.event.INoProguard
-keepclasseswithmembers class * implements com.liang530.event.INoProguard{
    <fields>;
    <methods>;
}
