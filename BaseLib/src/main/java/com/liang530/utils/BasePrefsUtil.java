...
public class BasePrefsUtil {
    ...
    public synchronized static BasePrefsUtil getPrefsUtil(String prefsname) {
    ...
    public static void init(Context context, String prefsname, int mode) {
        if (prefsHashMap.containsKey(prefsname)) {
            L.e("BasePrefsUtil", prefsname + "已初始化");
            return;
        }
        BasePrefsUtil prefsUtil = new BasePrefsUtil();
    ...
    public BasePrefsUtil putString(String key, String value) {
        editor.putString(key, value);
//        editor.commit();
        return this;
    }

    public BasePrefsUtil putInt(String key, int value) {
        editor.putInt(key, value);
//        editor.commit();
        return this;
    }

    public BasePrefsUtil putFloat(String key, float value) {
        editor.putFloat(key, value);
//        editor.commit();
        return this;
    }

    public BasePrefsUtil putLong(String key, long value) {
        editor.putLong(key, value);
//        editor.commit();
        return this;
    }

    public BasePrefsUtil putBoolean(String key, boolean value) {
...
//        editor.commit();
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public BasePrefsUtil putStringSet(String key, Set<String> value) {
