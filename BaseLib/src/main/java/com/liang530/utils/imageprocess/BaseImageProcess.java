package com.liang530.utils.imageprocess;
...
import com.liang530.utils.BaseViewUtil;
import com.liang530.utils.imageprocess.blur.FastBlur;

/**
 */
public class BaseImageProcess {
    public static final String TAG = BaseImageProcess.class.getSimpleName();
...
//        canvas.translate(-view.getLeft()/scaleFactor, -view.getTop()/scaleFactor);
    ...
    public static void fastBlurSetBg(Context context, Bitmap bm, View view, boolean downScale, float scaleFactor) {
        ...
        BaseViewUtil.setBackgroundDrawable(view, new BitmapDrawable(context.getResources(), overlay));
    }
    /***************************************BLUR END****************************************/
...
//        Bitmap b = BitmapFactory.decodeFile(filePath, options);
        ...
        BaseFileUtil.recycleBitmap(smallBm);
        return zoomBm;
    }
...
//        float ww = 480f;//这里设置宽度为480f
        ...
        try {
            ...
            BaseFileUtil.closeIO(isBm, os);
            BaseFileUtil.recycleBitmap(bitmap);
        }
...
//        float ww = 480f;//这里设置宽度为480f
        ...
        try {
            ...
            BaseFileUtil.recycleBitmap(bitmap);
            BaseFileUtil.closeIO(commpressedBm);
        }
        return resultBm;
    }
...
//		Bitmap originalBitmap = drawableToBitmap(drawable);
    ...
    public static Drawable zoomDrawable(Drawable drawable, int w, int h) {
        ...
        Bitmap newbmp = Bitmap.createBitmap(oldbmp, 0, 0, width, height,
                matrix, true);
        BaseFileUtil.recycleBitmap(oldbmp);
    ...
    public static Bitmap formatCameraPictureOriginal(String path, Bitmap bitmap) {
         ...
         */
        int degree = BaseImageProcess.readPictureDegreeFromExif(path);
        if (0 == degree) {
            return bitmap;
        }
        /**
    ...
    public static Bitmap formatCameraPicture(String path) {
        ...
        BaseFileUtil.recycleBitmap(cbitmap);
        return newbitmap;
    }
