...
public class VoiceRecorder {
	...
	public String startRecording(String userid, Context context) {
		...
		L.e("voice", "start voice recording to file:" + this.file.getAbsolutePath());
	...
	public int stopRecoding() {
		if (this.recorder != null) {
			...
			L.e("voice", "voice recording finished. seconds:" + i + " file length:" + new File(this.voiceFilePath).length());
			return i;
		}
		return 0;
	}
