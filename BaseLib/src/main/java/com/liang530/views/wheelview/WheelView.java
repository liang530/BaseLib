...
import com.liang530.views.wheelview.adapter.WheelViewAdapter;
...
//			0x00FFFFFF, 0x00FFFFFF };
	...
	private int wheelForeground = android.R.color.transparent;
	private int wheelLineColor = android.R.color.darker_gray;
	...
	// Scrolling com.kufeng.hj.cancer.listener
	...
	public int getWheelLineColor() {
		return wheelLineColor;
	}

	public void setWheelLineColor(int wheelLineColor) {
	...
	// Adapter com.kufeng.hj.cancer.listener
	...
	/**
	 * Adds wheel changing com.kufeng.hj.cancer.listener
	 * @param listener the com.kufeng.hj.cancer.listener
	 */
	...
	/**
	 * Removes wheel changing com.kufeng.hj.cancer.listener
	 * @param listener the com.kufeng.hj.cancer.listener
	 */
	...
	/**
	 * Adds wheel scrolling com.kufeng.hj.cancer.listener
	 * @param listener the com.kufeng.hj.cancer.listener
	 */
	...
	/**
	 * Removes wheel scrolling com.kufeng.hj.cancer.listener
	 * @param listener the com.kufeng.hj.cancer.listener
	 */
	...
	/**
	 * Adds wheel clicking com.kufeng.hj.cancer.listener
	 * @param listener the com.kufeng.hj.cancer.listener
	 */
	...
	/**
	 * Removes wheel clicking com.kufeng.hj.cancer.listener
	 * @param listener the com.kufeng.hj.cancer.listener
	 */
...
//		int height = (int)(3 * getItemHeight());
		//*/
		//modified by liuhongliang 2016-06-05  动态计算要画阴影的部分
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(wheelLineColor));
		// 设置线宽
