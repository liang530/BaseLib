...
public class AdvanceSwipeRefresh extends LinearLayout implements OnRecyclerViewScrollLocationListener,PtrHandler {
     ...
     * 最长加载时间,超时,刷新控件将重置
     */
    private int maxLoadTime=3*1000;
    ...
    }public void setEmptyViewTextColor(int textColor){
        tvEmptyView.setTextColor(textColor);
    }
...
//        initLoadMore(footviewLayout);
        ...
        tvEmptyView = ((TextView) layout.findViewById(R.id.tv_empty_view));
...
//        circleProgressBar.setShowArrow(true);
    ...
    private void initRefresh(PtrFrameLayout refreshLayout){
        ...
        header.setPadding(0, BaseAppUtil.dip2px(getContext(), 15), 0, BaseAppUtil.dip2px(getContext(), 10));
